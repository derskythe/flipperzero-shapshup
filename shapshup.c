...
ShapShupState *shapshup_alloc() {
  ...
  instance->scene_manager =
      scene_manager_alloc(&shapshup_scene_handlers, instance);
  ...
  view_dispatcher_add_view(instance->view_dispatcher, ShapShupViewTextInput,
                           text_input_get_view(instance->text_input));

  // Custom Widget
  instance->widget = widget_alloc();
  view_dispatcher_add_view(instance->view_dispatcher, ShapShupViewWidget,
                           widget_get_view(instance->widget));

  // Popup
  instance->popup = popup_alloc();
  view_dispatcher_add_view(instance->view_dispatcher, ShapShupViewPopup,
                           popup_get_view(instance->popup));

  // Loading
  instance->loading = loading_alloc();
  view_dispatcher_add_view(instance->view_dispatcher, ShapShupViewLoading,
                           loading_get_view(instance->loading));

  // ViewStack
  instance->view_stack = view_stack_alloc();
  view_dispatcher_add_view(instance->view_dispatcher, ShapShupViewStack,
                           view_stack_get_view(instance->view_stack));

  // ShapShupMainView
  instance->view_main = shapshup_main_view_alloc();
  view_dispatcher_add_view(instance->view_dispatcher, ShapShupViewMain,
...
int32_t shapshup_app(void *p) {
  ...
  view_dispatcher_attach_to_gui(instance->view_dispatcher, instance->gui,
